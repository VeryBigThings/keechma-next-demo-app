...
(defmethod wrapped-input :text [props]
  (d/fieldset {:class (str "margin-auto h-16 w-full input-field-focus" (:assoc/class props))}
              (input (assoc props :class (str (if (not (:prepend/icon props))
                                                "min-w-full pb-3 pt-3 pl-2 outline-none bg-gray-400 border-b border-solid border-orange-500
                                                          focus:border-orange-200 hover:bg-gray-500 focus:bg-gray-500 placeholder-gray-700"
                                                "min-w-full pb-3 pt-3 pl-8 outline-none bg-gray-400 border-b border-red-600 focus:border-2")
